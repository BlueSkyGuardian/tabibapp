import { BUILD_ID_FILE, BUILD_MANIFEST, CLIENT_REFERENCE_MANIFEST, NEXT_FONT_MANIFEST, PRERENDER_MANIFEST, REACT_LOADABLE_MANIFEST, ROUTES_MANIFEST, SERVER_FILES_MANIFEST, SERVER_REFERENCE_MANIFEST, SUBRESOURCE_INTEGRITY_MANIFEST } from '../../shared/lib/constants';
 ...
 */ export class RouteModule {
    ...
    loadManifests(projectDir, srcPage) {
        if (process.env.NEXT_RUNTIME !== 'edge') {
            var _clientReferenceManifest___RSC_MANIFEST;
            const { loadManifestFromRelativePath } = require('../load-manifest.external');
            const normalizedPagePath = normalizePagePath(srcPage);
            const [routesManifest, prerenderManifest, buildManifest, reactLoadableManifest, nextFontManifest, clientReferenceManifest, serverActionsManifest, subresourceIntegrityManifest, serverFilesManifest, buildId] = [
